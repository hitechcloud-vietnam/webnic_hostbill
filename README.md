...
- `webnic_common` - shared WebNIC API client
...
`webnic_common/lib/class.webnic_api_client.php` provides:
...
- `webnic_common` -> keep available as a shared sibling dependency or bundle it with each target deployment strategy
